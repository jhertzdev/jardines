...
<script setup>
  ...
  onMounted(() => {
    ...
    let baseDate = new Date(2023, 0, 31); // 31 Enero 2023
    let lastDate = new Date(2023, 1, 28); // 28 Febrero 2023





    console.log(agregarPorFechaCorte(lastDate, baseDate, 1))
    console.log(agregarPorFechaCorte(lastDate, baseDate, 2))
    console.log(agregarPorFechaCorte(lastDate, baseDate, 3))
    console.log(agregarPorFechaCorte(lastDate, baseDate, 4))
