<template>
  <q-select ref="select" class="select-ubicaciones-linea" :hint="hint" option-label="codigo_parcela" option-value="id" v-model="props.modelValue" v-bind="$attrs" :options="options" :lazy-rules="props.required" input-debounce="500" @filter="filterFn" map-options multiple use-chips @update:model-value="updateValue">
