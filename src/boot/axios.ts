...
//const api = axios.create({ baseURL: 'http://jardines-backend.test/api', timeout: 15000 })
const api = axios.create({ baseURL: 'http://192.168.94.1/jardines-backend/public/api', timeout: 15000 })
